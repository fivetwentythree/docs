...
{: note }
Before we get to the axioms themselves, we need to agree on some basic vocabulary and concepts. [we discussed this before](/docs/Probability-and-Statistics/1-sample-spaces/) but I think a refrehsher might serve you well.
